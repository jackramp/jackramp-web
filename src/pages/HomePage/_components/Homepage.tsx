...
export default function Homepage() {
  return (
    <div className="container mx-auto min-h-screen flex flex-col lg:flex-row items-center justify-between gap-8 px-4 py-8 md:px-8 lg:px-12 xl:px-16 mt-[120px] lg:mt-0">
